...
- Slack: [@{instructor slack handle}]( https://deepdivecoding.slack.com/team/{instructor id} )
- LinkedIn: https://www.linkedin.com/in/{instructor LinkedIn}/
- GitHub: https://github.com/{instructor github}
...
The first day of lecture is on {day}, {month} {date}, and starts at 8:00am.

**Due Dates:**
* Phase 1: 17 days before the start of the bootcamp
* Phase 2: 12 days before the start of the bootcamp
* Phase 3: 10 days before the start of the bootcamp
* Phase 4:  4 days before the start of the bootcamp
* Phase 5: Optional
...
( estimated time to completion: 3 hours ; due 5pm MT, {day}, {month} {date} )
...
[Data Science Coaching Intake Survey]( https://cnm.formstack.com/forms/{intake survey})

After setting up your student accounts and filling out the survey, contact our Coach, {coach}. {coach} would like to meet with you as soon as possible to learn more about you and your goals. Establishing an early relationship with your coach allows us to personalize your success plan. Please let {coach} know when you are available to meet so that she can coordinate schedules. {coach} can be reached at {coach e-mail}.
...
( estimated time to completion: 10 hours ; due 5pm MT, {day}, {month} {date} )
...
- Exercise 1: [Descriptive Statistics - 1]( prework/desc-stat-1.md )
- Exercise 2: [Descriptive Statistics - 2]( prework/desc-stat-2.md )
- Exercise 3: [Pivot Tables]( prework/pivot.md )

When you have completed the exercises, create a Google Drive folder named `DS-Phase-02`, save these in that folder, share the folder with your instructor ( use the gmail address <a href="mailto:{instructor e-mail}">{instructor e-mail}</a> ), and notify your instructor via a DM on Slack.  We will go over these exercises on the first day of instruction and again later in the course.
...
( estimated time to completion: 20 hours ; due 5pm MT, {day}, {month} {date}  )
