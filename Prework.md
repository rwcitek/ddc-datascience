...
- Internet search, e.g. [Google]( https://www.google.com/ ), [Bing]( https://www.bing.com/ ), [DuckDuckGo]( https://duckduckgo.com/ )
- AI assistance, e.g. [Gemini]( https://gemini.google.com/ ), [ChatGPT]( https://chatgpt.com/ ), [Claude]( https://claude.ai/ ), [NotebookLM]( https://notebooklm.google.com/ ) ( more on this in the future )
- your fellow students via [Slack]( https://app.slack.com/client/T053NFY3R/ )
- alumni via Slack ( they tend to lurk, but emerge when asked )
- your professional network on [LinkedIn ]( https://www.linkedin.com/ )
- [GitHub]( https://github.com/ )
- [LinkedIn Learning via the ABQ/Bern Library]( https://abqlibrary.org/az/linkedin-learning-formerly-lyndacom )
- [O'Reilly Learning Library]( https://learning.oreilly.com/home/ )

... not always, but often in that order
...
If you don't already have one, you will need to sign up for a [LinkedIn]( https://www.linkedin.com/ ) account.  We also strongly recommend bookmarking it in your browser and installing the [LinkedIn App]( https://mobile.linkedin.com/ ) on your mobile device.  In addition, we recommend that you install the [LinkedIn Learning App]( https://www.linkedin.com/help/learning/answer/a701889 ).


## Slack

You should get an email invite to join Deep Dive Coding's Slack group, using your personal e-mail address.  Do this as soon as possible.  We also strongly recommend bookmarking it in your browser and installing the [Slack App]( https://slack.com/downloads/other ) on your mobile device.
...
Once that you have a library card, log in to [LinkedIn Learning via the ABQ Library]( https://www.linkedin.com/learning-login/go/cabq ) and pick one of the courses from below to watch all the videos in that course.  These are nice survey courses in Data Science.

1. [The Data Science of Economics, Banking, and Finance]( https://www.linkedin.com/learning/the-data-science-of-economics-banking-and-finance/ )
...
1. [The Data Science of Media and Entertainment]( https://www.linkedin.com/learning/the-data-science-of-media-and-entertainment-with-barton-poulson )
1. [The Data Science of Nonprofit Service Organizations]( https://www.linkedin.com/learning/the-data-science-of-nonprofit-service-organizations-with-barton-poulson )
...
Once you have registered and logged in, click on your profile icon in the upper right corner of the window and click "My profile".  The URL in the address bar should begin with `https://hub.docker.com/u/` and end in your username.  Copy that link for later. Also, save your credentials in your password manager.
...
You will need to create a Github account at [www.github.com]( https://www.github.com/ ).  You can follow along with the instructions in the video below.  Here are a few things to keep in mind along the way:
...
To keep pace with the rigor of this course, it is essential to leverage every tool at your disposal. Generative AI ( GenAI ) has become a premier force multiplier for learning, offering a way to iterate on ideas and troubleshoot blocks with unprecedented speed. These resources will guide you in using AI as a 'co-pilot' rather than a substitute, ensuring you can learn faster, understand more clearly, and focus your energy on the high-level concepts that matter most.

Read through the first three chapters of [AI Prompt Engineering Absolute Beginners Guide]( https://learning.oreilly.com/library/view/ai-prompt-engineering/9780135570449/ )
- [1-Understanding Generative AI]( https://learning.oreilly.com/library/view/ai-prompt-engineering/9780135570449/ch01.xhtml )
- [2-What Is Prompt Engineering—and Why Is It Important?]( https://learning.oreilly.com/library/view/ai-prompt-engineering/9780135570449/ch02.xhtml )
- [3-The Anatomy of a Perfect Prompt]( https://learning.oreilly.com/library/view/ai-prompt-engineering/9780135570449/ch03.xhtml )

View this video from [AI as Your Personal Learning Coach]( https://learning.oreilly.com/course/ai-as-your/9780135588727/ ) which covers using Google's NotebookLM.

- [3.4 AI-Powered Study Notes with NotebookLM]( https://learning.oreilly.com/videos/ai-as-your/9780135588727/9780135588727-AYPLC1_01_03_04/ )
...
Try creating some other artifacts like flash cards and videos.  Clicking on the '>' of an artifact allows you to customize it especially if you modify the default prompt.

Later and if you have time, skim/read/view the full content of both of those Generative AI resources.
...
- [Introduction to Prompt Engineering for Generative AI]( https://www.linkedin.com/learning/introduction-to-prompt-engineering-for-generative-ai-24636124 ) on LinkedIn Learning.
...
- Enabling [ Windows Subsystem for Linux 2 (WSL2) and Docker on Windows]( https://gist.github.com/rwcitek/f2b6fb5baddf16f6dc1f277a5d9f8366 )
...
- [The Missing Semester of Your CS Education]( https://missing.csail.mit.edu/ ) Everything up through the git lecture would be relevant to this course, but it is all good stuff to know.
...
- Jupyter notebooks of the [Whirlwind Tour of Python]( https://github.com/jakevdp/WhirlwindTourOfPython/blob/master/00-Introduction.ipynb ) by Jake VanderPlas, one of the creators of Google's CoLab.  We will cover most if not all of the material in this book.

- Jupyter notebooks of the [Python Data Science Handbook by Jake Vanderplas]( https://github.com/jakevdp/PythonDataScienceHandbook/tree/master/notebooks )

- [Introduction to SQLite]( https://www.linkedin.com/learning/introduction-to-sqlite ) by Brian Jepson on LinkedIn Learning.
