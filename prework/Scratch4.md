# Exercise 4: Meow with Loops

For this exercise, you'll rebuild "Meow x3" using a loop instead of manually 
duplicating blocks.
...
7. Disconnect your remaining "play sound Meow until done" + "wait 1 seconds" 
   ...
   "repeat" block, so the pair sits nested inside the loop.
8. In the repeat block, click the white oval and change the number from 10 to 3.
9. Attach the "repeat (3)" block under "when green flag clicked".
13. Run your program. The cat should meow three (3) times, just like in 
   Exercise 3, but this time using far fewer blocks.
14. Save your project ("File" > "Save now"), then download "Meow-Loop.sb3" 
