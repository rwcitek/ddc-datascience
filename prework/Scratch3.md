...
We want the cat to meow three times.

1. Go to https://scratch.mit.edu and log in.
2. Open a new Scratch project, naming it "Meow".
3. Click the yellow "Events" category.
4. Drag "when green flag clicked" onto your canvas.
5. Click the pink "Sound" category.
6. Drag "play sound Meow until done" onto your canvas.
7. Click the orange "Control" category.
8. Drag "wait 1 seconds" onto your canvas.
